...
const recentDynamicList = ref<Array<RecentDynamicData>>([
  {
    ...
    img: new URL("/src/assets/img/fate2.jpg", import.meta.url).href,
    context: "留个言呢呢呢",
    url: "/cover",
  },
  {
    ...
    img: new URL("/src/assets/img/fate1.jpg", import.meta.url).href,
    context: "【更新文章简介】",
    url: "/cover",
  },
  {
    ...
    img: new URL("/src/assets/img/fate3.jpg", import.meta.url).href,
    context: "【最多人看嫩】",
    url: "/cover",
  },
  {
    ...
    img: new URL("/src/assets/img/fate4.jpg", import.meta.url).href,
    context: "留个言呢呢呢",
    url: "/cover",
  },
])
